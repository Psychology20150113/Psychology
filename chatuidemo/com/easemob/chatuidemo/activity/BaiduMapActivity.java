...
public class BaiduMapActivity extends BaseActivity {
	...
	private void showMapWithLocationClient() {
		...
		progressDialog.setMessage("姝ｅ湪纭畾浣犵殑浣嶇疆...");
	...
	public void initEngineManager(Context context) {
		...
		if (!mBMapManager.init(strKey, new MyGeneralListener())) {
			Toast.makeText(this.getApplicationContext(), "BMapManager  鍒濆鍖栭敊璇�!", Toast.LENGTH_LONG).show();
		}
	}
	...
	class MyGeneralListener implements MKGeneralListener {
		...
		public void onGetNetworkState(int iError) {
			if (iError == MKEvent.ERROR_NETWORK_CONNECT) {
				Toast.makeText(BaiduMapActivity.this, "鎮ㄧ殑缃戠粶鍑洪敊鍟︼紒", Toast.LENGTH_LONG).show();
			} else if (iError == MKEvent.ERROR_NETWORK_DATA) {
				Toast.makeText(BaiduMapActivity.this, "杈撳叆姝ｇ‘鐨勬绱㈡潯浠讹紒", Toast.LENGTH_LONG).show();
			}
			// ...
		}
